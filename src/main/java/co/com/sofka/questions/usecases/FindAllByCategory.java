...
@Service
@Validated
public class FindAllByCategory implements Function<String, Flux<QuestionDTO>> {
    ...
    public FindAllByCategory(QuestionRepository questionRepository, AnswerRepository answerRepository, MapperQuestion mapperQuestion, MapperAnswer mapperAnswer) {
